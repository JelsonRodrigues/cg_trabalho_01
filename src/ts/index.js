...
const SplinePath_1 = require("./SplinePath");
var canva;
var gl;
var spline;
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        // Get canvas
        canva = document.getElementById("mainCanvas");
        canvasResize(canva);
        // Setup gl
        gl = canva.getContext("webgl2");
        ...
        objects.push(new F_1.F(gl), new Pyramid_1.Pyramid(gl), new Ground_1.Ground(gl), new CameraCoordinates_1.CameraCoordinates(gl), new Virus_1.Virus(gl), new GlowKnife_1.GlowKnife(gl), new SplinePath_1.SplinePoints(gl, spline));
        setupEventHandlers();
        start = Date.now();
        animateTiangle();
    });
    ...
    objects.forEach((drawable_obj) => {
        if (drawable_obj.draw !== undefined) {
            if (drawable_obj instanceof CameraCoordinates_1.CameraCoordinates) {
                ...
                drawable_obj.UpdatePoints(gl, [x[0], x[1], x[2]], [y[0], y[1], y[2]], [z[0], z[1], z[2]]);
